...
//   const { uploadFile, isLoading } = useFileUploadContext();
...
//             className="my-5 flex h-40 flex-1 cursor-pointer flex-col items-center justify-center gap-2 overflow-hidden rounded-2xl border-1 border-dashed border-gray-500 bg-gray-100 duration-400 hover:bg-gray-300"
//           >
